...
public class BooksApplicationInit implements CommandLineRunner {
    ...
    BooksApplicationInit(AuthorRepository authorRepository, BookRepository bookRepository) {
